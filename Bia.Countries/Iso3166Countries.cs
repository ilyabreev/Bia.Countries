...
namespace Bia.Countries
{
    ...
    {
        private static Dictionary<string, Iso3166Country> _list = new Dictionary<string, Iso3166Country>()
        {
        ...
        private static Dictionary<string, Iso3166Country> List
        {
            get { return _list; }
        }

        public static string GetAlpha2CodeByName(string countryName)
        {
            if (!List.ContainsKey(countryName))
            {
                return null;
            }

            return List[countryName].Alpha2;
        }
    }
}
